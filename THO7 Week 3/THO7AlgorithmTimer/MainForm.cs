...
namespace THO7AlgorithmTimerApplication
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            AlgorithmList.Add(new MedianFilter3x3("Median Filter 3x3 gray"));
            AlgorithmList.Add(new MedianFilter11x11("Median Filter 11x11 gray"));
            AlgorithmList.Add(new MedianFilterAlgorithmV2("Median Filter 3x3 color", 3));
            AlgorithmList.Add(new MedianFilterAlgorithmV2("Median Filter 11x11 color", 11));
            AlgorithmList.Add(new SaltPepper("Add 5% salt&pepper noise", 5));
            AlgorithmList.Add(new SaltPepper("Add 40% salt&pepper noise", 40));
