...
{
    class MedianFilter11x11 : VisionAlgorithm
    {
        public MedianFilter11x11(String name) : base(name) { }
        public override System.Drawing.Bitmap DoAlgorithm(System.Drawing.Bitmap sourceImage)
        {

            // Size of matrix (this case 11), we tried to do this in the constructor as parameter but not enough time to fix it.
            int Matrixsize = 11;
            ...
            for (int medianFilterOffsetY = medianFilterOffset; medianFilterOffsetY < Height - medianFilterOffset; medianFilterOffsetY++)
            {
                ...
                for (int medianFilterOffsetX = medianFilterOffset; medianFilterOffsetX < Width - medianFilterOffset; medianFilterOffsetX++)
                {
                    ...
                    // Clears the list so it can be used for the next 121 ints
                    ...
                    for (int medianFilterY = -medianFilterOffset; medianFilterY <= medianFilterOffset; medianFilterY++)
                    {
                        ...
                        {
                            // Calculates the median filter pixels and fills the list medianFilterPixels with median filter values (121 in this case) 
                    ...
                    // Sorting List which contains 121 numbers from low to high
